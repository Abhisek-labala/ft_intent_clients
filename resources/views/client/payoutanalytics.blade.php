...
<!-- Buttons for payout and Payout -->
<div class="row mb-4">
    <div class="col-lg-6 col-md-6">
        <button id="payoutBtn" class="btn btn-primary">payout</button>
    </div>
</div>
...
$(document).ready(function() {
    ...
    // Fetch initial data for payout by default
    fetchData($('#startDate').val(), $('#endDate').val(), 'payout');
